...
storage "raft" {
  ...
  retry_join {
    ...
    auto_join = "provider=azure subscription_id=${azure_sub_id} tenant_id=${azure_tenant_id} resource_group=${azure_rg} vm_scale_set=${azure_vmss} secret_access_key=update client_id=${azure_sp_client_id}"
  }
}
